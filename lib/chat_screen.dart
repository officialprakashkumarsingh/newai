          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: TextField(controller: _controller, enabled: !_isStreaming, onSubmitted: _isStreaming ? null : (val) => _sendMessage(val), textInputAction: TextInputAction.send, maxLines: 5, minLines: 1, decoration: InputDecoration(hintText: _isStreaming ? 'AhamAI is responding...' : 'Ask AhamAI anything...', filled: true, fillColor: isLightTheme(context) ? Colors.white : const Color(0xFF31363F), contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), border: OutlineInputBorder(borderRadius: BorderRadius.circular(24), borderSide: BorderSide.none))),
                ),
                const SizedBox(width: 8),
