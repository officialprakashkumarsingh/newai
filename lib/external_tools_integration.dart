...
class ExternalToolsIntegration {
  ...
  static bool _containsFileCreationIntent(String response) {
    final patterns = [
      ...
      r'make a file',
      r'write.*file',
      r'save.*as.*\.(txt|html|css|json|xml|md|js|py|csv|pdf)',
      r'create.*\.(txt|html|css|json|xml|md|js|py|csv|pdf)',
      r'generate.*\.(txt|html|css|json|xml|md|js|py|csv|pdf)',
      r'make.*\.(txt|html|css|json|xml|md|js|py|csv|pdf)',
      r'export.*file',
      r'download.*file',
      r'save.*document',
      r'create.*document.*file',
      r'generate.*report.*file',
      r'i will create.*file',
      r'let me create.*file',
      r'creating.*file',
      r"i'll create.*file",
      r'create.*script',
      r'generate.*code.*file',
      r'make.*html.*file',
      r'create.*json.*file',
      r'generate.*csv.*file',
    ];
